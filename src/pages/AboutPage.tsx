        ...
        <div className="relative z-10 max-w-[1320px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-14 items-center">
            ...
            <div className="relative">
              ...
              {/* Top Badge */}
              <div className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 max-w-[calc(100%-1rem)] bg-white/95 backdrop-blur-md border border-brand-600/20 p-2 sm:p-3 rounded-2xl flex items-center gap-2 sm:gap-2.5 shadow-xl animate-floatSm">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-gradient-to-r from-brand-600 to-brand-400 flex items-center justify-center shrink-0">
                ...
                <div className="min-w-0">
                  <div className="font-heading font-bold text-[11px] sm:text-xs text-brand-600 whitespace-nowrap">Capability Orbit Framework</div>
                  <div className="text-[9px] sm:text-[10px] text-slate-500 whitespace-nowrap">REHEARSE · LEAP LMS</div>
                </div>
              </div>

              {/* Bottom Badge */}
              <div className="absolute -bottom-2 -left-2 sm:-bottom-3 sm:-left-3 max-w-[calc(100%-1rem)] bg-white/95 backdrop-blur-md border border-coral-500/20 px-2.5 py-2 sm:px-4 sm:py-2.5 rounded-2xl shadow-xl animate-floatSm">
                <div className="font-heading font-bold text-[11px] sm:text-xs text-coral-500 whitespace-nowrap">Global Footprint</div>
                <div className="text-[9px] sm:text-[10px] text-slate-500 whitespace-nowrap">Hyderabad HQ (T-Hub) · US · EU</div>
              </div>
            </div>
          </div>
        </div>
